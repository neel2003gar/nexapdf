...
export default function PowerPointToPDFPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      formData.append('pptx', files[0])

      const response = await axios.post(`${API_URL}/pdf/convert/powerpoint-to-pdf/`, formData, {
        headers: {
      ...
      setProcessingStats({
        ...
        processingTime,
        fileCount: 1,
        operationType: 'PowerPoint to PDF Conversion'
      })
      
      // Notify about successful operation (this will trigger usage updates)
      notifyOperation('powerpoint-to-pdf', true)
      ...
      if (error.response?.status === 401) {
        ...
        showToast.error.processingFailed('PowerPoint to PDF conversion')
      }
    } finally {
      setUploading(false)
      setProgress(0)
  ...
  const handleDownload = () => {
    if (downloadUrl) {
      const originalName = files[0]?.name || 'presentation'
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <Presentation className="mx-auto h-16 w-16 text-red-500 mb-4" />
            <h1 className="text-4xl font-bold mb-4">PowerPoint to PDF</h1>
            ...
            {files.length > 0 && (
              <div className="space-y-6">
                ...
                <ProcessingResult
                  ...
                  filename={`${files[0]?.name.replace(/\.[^/.]+$/, '') || 'presentation'}.pdf`}
                />
              </div>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="p-6 bg-red-50 dark:bg-red-900/20 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-red-800 dark:text-red-200">
                  <li>• Converts PPTX presentations to PDF format</li>
                  <li>• Preserves slide layouts and formatting</li>
                  <li>• Maintains animations as static content</li>
                  <li>• Creates shareable, print-ready documents</li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
                  ...
                  <li>• Animations become static images</li>
                  <li>• Perfect for sharing presentations</li>
