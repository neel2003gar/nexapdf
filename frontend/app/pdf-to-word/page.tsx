...
export default function PDFToWordPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/pdf/convert/pdf-to-word/`, formData, {
        headers: {
      ...
      setProcessingStats({
        ...
        processingTime,
        fileCount: 1,
        operationType: 'PDF to Word'
      })
      
      showToast.success.convert()
      
      // Notify about completed operation
      notifyOperation('pdf-to-word', true)
    } catch (error: any) {
      console.error('Convert error:', error)
      if (error.response?.status === 401) {
        showToast.error.authRequired()
      } else {
        showToast.error.processingFailed('PDF to Word conversion')
      }
      
      // Notify about failed operation
      notifyOperation('pdf-to-word', false)
    } finally {
      setUploading(false)
      setProgress(0)
    }
        ...
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground text-lg">
              Convert your PDF documents to editable Word files (.docx format)
            </p>
          </div>
            ...
            {files.length > 0 && (
              <div className="space-y-4">
                ...
                <ProcessingResult
                  ...
                  filename={files[0]?.name?.replace('.pdf', '.docx') || 'converted.docx'}
                />
              </div>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="p-6 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-blue-800 dark:text-blue-200">
                  ...
                  <li>• Creates fully editable Word documents</li>
                  <li>• Supports both text-based and scanned PDFs</li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
                  ...
                  <li>• Scanned PDFs may require OCR processing</li>
