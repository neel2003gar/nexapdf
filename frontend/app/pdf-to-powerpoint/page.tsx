...
export default function PDFToPowerPointPage() {
  ...
  const handleConvert = async () => {
    ...
    try {
      ...
      const response = await axios.post(`${API_URL}/pdf/convert/pdf-to-powerpoint/`, formData, {
        headers: {
      ...
      setProcessingStats({
        ...
        processingTime,
        fileCount: 1,
        operationType: 'PDF to PowerPoint Conversion'
      })
      
      // Notify about successful operation (this will trigger usage updates)
      notifyOperation('pdf-to-powerpoint', true)
      ...
      if (error.response?.status === 401) {
        ...
        showToast.error.processingFailed('PDF to PowerPoint conversion')
      }
    } finally {
      setUploading(false)
      setProgress(0)
      ...
      <main className="flex-1 container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <Presentation className="mx-auto h-16 w-16 text-orange-500 mb-4" />
            <h1 className="text-4xl font-bold mb-4">PDF to PowerPoint</h1>
            ...
            {files.length > 0 && (
              <div className="space-y-6">
                ...
                <ProcessingResult
                  ...
                  filename={`${files[0]?.name.replace(/\.[^/.]+$/, '') || 'presentation'}.pptx`}
                />
              </div>
            )}
            ...
            <div className="grid md:grid-cols-2 gap-6 mt-8">
              <div className="p-6 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
                <h3 className="font-semibold text-orange-900 dark:text-orange-100 mb-3">
                  What is PDF to PowerPoint?
                </h3>
                <ul className="space-y-2 text-sm text-orange-800 dark:text-orange-200">
                  <li>• Converts PDF pages to PowerPoint slides</li>
                  <li>• Extracts text for easy editing</li>
                  <li>• Preserves images and layout structure</li>
                  <li>• Creates editable presentation format</li>
                </ul>
              </div>
              ...
              <div className="p-6 bg-green-50 dark:bg-green-900/20 rounded-lg">
                ...
                <ul className="space-y-2 text-sm text-green-800 dark:text-green-200">
                  ...
                  <li>• Each PDF page becomes a slide</li>
                  <li>• Review formatting after conversion</li>
                  <li>• Use for creating editable presentations</li>
                </ul>
              </div>
            </div>
          </div>
